...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        int[] array = Helper.getArray(arrayLength);

        // Divide array for threads
        List subArrays = Helper.divideArray(array, threadsMax);
        ...
        // Merge into one
        int[] array12 = Helper.merge(array1, array2);
        int[] array34 = Helper.merge(array3, array4);
        int[] finalArray = Helper.merge(array12, array34);
